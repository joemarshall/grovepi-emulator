...
namespace eval ttk::theme::azure-light {
    ...
    ttk::style theme create azure-light -parent clam -settings {
        ...
        ttk::style layout LightUp.TButton {
            Button.padding -children {
                LightUpButton.button -children {
                    Button.label -side left -expand true
                } 
            }
        }
        ...
        # Button
        ttk::style configure TButton -padding {4 4 4 4} -width -10 -anchor center
        ...
        ttk::style element create LightUpButton.button image \
            [list $I(rect-basic) \
            	{selected disabled} $I(rect-basic) \
                disabled $I(rect-basic) \
                selected $I(rect-basic) \
        ...
        # AccentButton
        ttk::style configure Accent.TButton -padding {4 4 4 4} -width -10 -anchor center
        ...
        ttk::style element create Entry.field \
            image [list $I(box-basic) \
                ...
                focus $I(box-accent) \
                hover $I(box-hover) \
            ] -border 5 -padding {2} -sticky news
